...
class Ui_MocapClipperWidget(object):
    def setupUi(self, MocapClipperWidget):
        ...
        self.open_time_editor_BTN = QPushButton(self.widget_2)
        self.open_time_editor_BTN.setObjectName(u"open_time_editor_BTN")
        sizePolicy = QSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.open_time_editor_BTN.sizePolicy().hasHeightForWidth())
        self.open_time_editor_BTN.setSizePolicy(sizePolicy)
        self.open_time_editor_BTN.setMinimumSize(QSize(0, 30))

        self.horizontalLayout_5.addWidget(self.open_time_editor_BTN)


        self.verticalLayout_3.addLayout(self.horizontalLayout_5)

        self.set_time_range_from_selection_CHK = QCheckBox(self.widget_2)
        self.set_time_range_from_selection_CHK.setObjectName(u"set_time_range_from_selection_CHK")
        self.set_time_range_from_selection_CHK.setMinimumSize(QSize(0, 30))
        self.set_time_range_from_selection_CHK.setChecked(True)

        self.verticalLayout_3.addWidget(self.set_time_range_from_selection_CHK)
        ...
        sizePolicy1.setHeightForWidth(self.clips_LW.sizePolicy().hasHeightForWidth())
        self.clips_LW.setSizePolicy(sizePolicy1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 689, 1114))
        ...
        sizePolicy2.setHeightForWidth(self.clip_name_LE.sizePolicy().hasHeightForWidth())
        self.clip_name_LE.setSizePolicy(sizePolicy2)
        font = QFont()
        ...
        sizePolicy3.setHeightForWidth(self.rename_clip_BTN.sizePolicy().hasHeightForWidth())
        self.rename_clip_BTN.setSizePolicy(sizePolicy3)
        ...
        self.source_path_LE = QLineEdit(self.scrollAreaWidgetContents)
        self.source_path_LE.setObjectName(u"source_path_LE")
        self.source_path_LE.setAlignment(Qt.AlignJustify|Qt.AlignVCenter)
        ...
        sizePolicy2.setHeightForWidth(self.frame_start.sizePolicy().hasHeightForWidth())
        self.frame_start.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.frame_end.sizePolicy().hasHeightForWidth())
        self.frame_end.setSizePolicy(sizePolicy2)
        ...
        sizePolicy3.setHeightForWidth(self.frame_duration.sizePolicy().hasHeightForWidth())
        self.frame_duration.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.start_pose_CHK.sizePolicy().hasHeightForWidth())
        self.start_pose_CHK.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.start_pose_CB.sizePolicy().hasHeightForWidth())
        self.start_pose_CB.setSizePolicy(sizePolicy4)
        ...
        sizePolicy3.setHeightForWidth(self.end_pose_CHK.sizePolicy().hasHeightForWidth())
        self.end_pose_CHK.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.end_pose_CB.sizePolicy().hasHeightForWidth())
        self.end_pose_CB.setSizePolicy(sizePolicy4)
        ...
        self.pose_match_CHK = QCheckBox(self.pose_configuration_widget)
        self.pose_match_CHK.setObjectName(u"pose_match_CHK")
        sizePolicy3.setHeightForWidth(self.pose_match_CHK.sizePolicy().hasHeightForWidth())
        self.pose_match_CHK.setSizePolicy(sizePolicy3)

        self.horizontalLayout_2.addWidget(self.pose_match_CHK)

        self.pose_match_type_CB = QComboBox(self.pose_configuration_widget)
        self.pose_match_type_CB.setObjectName(u"pose_match_type_CB")
        self.pose_match_type_CB.setEnabled(False)

        self.horizontalLayout_2.addWidget(self.pose_match_type_CB)

        self.pose_match_method_CB = QComboBox(self.pose_configuration_widget)
        self.pose_match_method_CB.setObjectName(u"pose_match_method_CB")
        ...
        sizePolicy5.setHeightForWidth(self.reproject_mocap_ctrl_BTN.sizePolicy().hasHeightForWidth())
        self.reproject_mocap_ctrl_BTN.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.reproject_root_anim_BTN.sizePolicy().hasHeightForWidth())
        self.reproject_root_anim_BTN.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.align_root_to_rig_BTN.sizePolicy().hasHeightForWidth())
        self.align_root_to_rig_BTN.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.toggle_root_aim_BTN.sizePolicy().hasHeightForWidth())
        self.toggle_root_aim_BTN.setSizePolicy(sizePolicy5)
        ...
        sizePolicy3.setHeightForWidth(self.save_clip_CHK.sizePolicy().hasHeightForWidth())
        self.save_clip_CHK.setSizePolicy(sizePolicy3)
        ...
        sizePolicy5.setHeightForWidth(self.output_path_W.sizePolicy().hasHeightForWidth())
        self.output_path_W.setSizePolicy(sizePolicy5)
        ...
        self.scene_actor_CB = QComboBox(self.bake_configuration_widget)
        self.scene_actor_CB.addItem("")
        self.scene_actor_CB.setObjectName(u"scene_actor_CB")
        sizePolicy6 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Fixed)
        sizePolicy6.setHorizontalStretch(0)
        sizePolicy6.setVerticalStretch(0)
        sizePolicy6.setHeightForWidth(self.scene_actor_CB.sizePolicy().hasHeightForWidth())
        self.scene_actor_CB.setSizePolicy(sizePolicy6)
        self.scene_actor_CB.setMinimumSize(QSize(0, 30))

        self.bake_actions_layout.addWidget(self.scene_actor_CB)

        self.connect_mocap_to_rig_BTN = QPushButton(self.bake_configuration_widget)
        ...
        self.bake_BTN = QPushButton(self.bake_configuration_widget)
        ...
        sizePolicy7.setHeightForWidth(self.bake_BTN.sizePolicy().hasHeightForWidth())
        self.bake_BTN.setSizePolicy(sizePolicy7)
    ...
    def retranslateUi(self, MocapClipperWidget):
        ...
        self.open_time_editor_BTN.setText(QCoreApplication.translate("MocapClipperWidget", u"Open Time Editor", None))
        self.set_time_range_from_selection_CHK.setText(QCoreApplication.translate("MocapClipperWidget", u"Set time range from selection", None))
        ...
        self.source_path_LE.setPlaceholderText(QCoreApplication.translate("MocapClipperWidget", u"Source Path", None))
        ...
        self.pose_match_CHK.setText(QCoreApplication.translate("MocapClipperWidget", u"Match", None))
        self.preprocess_mocap_actions_BTN.setText(QCoreApplication.translate("MocapClipperWidget", u"> Pre-Process Mocap", None))
        ...
        self.bake_configuration_BTN.setText(QCoreApplication.translate("MocapClipperWidget", u"> Bake", None))
